    ...
    def get_can_ip(self):
        ...
        for i in get_list[:20]:
            ...
            try:
                ...
                requests.get('https://sou.zhaopin.com/?jl=530&in=10100&kw=python&kt=3', proxies=proxies,headers=self.headers)
            except:
                continue
            else:
                # print(proxies)
...
def proxies(n):
    ...
    return can_p    #得到第n页的可用ip

if __name__ == '__main__':
    for n in range(1,2899):   #循环页数
        print(proxies(n))
