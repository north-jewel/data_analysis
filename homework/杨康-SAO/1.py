...
class HammerAxes(Axes):   
    ...
    def _set_lim_and_transforms(self):   
        ...
        self.transAffine = Affine2D().scale(0.5 / xscale, 0.5 / yscale) .translate(0.5, 0.5)   
        ...
        self._xaxis_pretransform = Affine2D().scale(1.0, np.pi).translate(0.0, -np.pi)   
    ...
    def set_longitude_grid_ends(self, degrees):   
        ...
        self._xaxis_pretransform.clear().scale(1.0, longitude_cap * 2.0).translate(0.0, -longitude_cap)   
