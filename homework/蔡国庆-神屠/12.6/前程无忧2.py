...
class Data2:
    ...
    def seek_data(self,h5,url):
        ...
        recruitment_info_dict['companu_url'] = company_url
    ...
    def save(self,recruitment_info_dict):
        ...
        location = r'C:\Users\16677\Desktop\qianchengwuyou\qiancheng_data4.csv'
    ...
    def read_url(self,url):
        h5 = self.reques(url)
        try:
            recruitment_info_dict = self.seek_data(h5,url)
            ...
            #print('{}链接爬取完成'.format(url[0]))
                ...
                try:
                    ...
                    df.to_csv(r'C:\Users\16677\Desktop\qianchengwuyou\error.csv')
                    print('{}报错已保存'.format(url[0]))
        # df_url = pd.read_csv(r'C:\Users\16677\Desktop\qianchengwuyou\xiangxiyemian_url2.csv')
        #
        # for url in df_url.values:
