...
class ZhaoPin:
    def __init__(self,headers,out_url_i = 530):
        self.header = headers
        self.outer_url = 'https://fe-api.zhaopin.com/c/i/sou?pageSize=60&cityId={}&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=python&kt=3&at=cb61f0195d5c4ebb8f41a288ae4f73f6&rt=cb54cccaa3284157b54994180426de07&_v=0.84894372&userCode=715503136&x-zp-page-request-id=d0446ce1e4ca4f49b0837535845f1c28-1543566149032-12188'.format(out_url_i)
    def Outer_url(self):
        ...
        #for i in range(2):
            ...
            company_welfar = dict_json['data']['results'][i]['welfare'][0]
            updateDate = dict_json['data']['results'][i]['updateDate']
            endDate = dict_json['data']['results'][i]['endDate']
            a = np.array([city,skill_type,company_name,company_size,company_type,edu_required,experience_required,company_welfar,updateDate,endDate])
            df = pd.DataFrame(a).T
            print(a)
