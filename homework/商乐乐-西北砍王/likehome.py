...
def love_home_love(url):
    ...
    for i in url_2:
        ...
        if res.status_code == 200:
            ...
            for x in house:
                ...
                housetype_1.append(huxingmianjichaoxianglouceng[0])
                area_1.append(huxingmianjichaoxianglouceng[1])
                district_1.append(district_metor[1])
                orientation_1.append(huxingmianjichaoxianglouceng[2])
                tage_1.append(huxingmianjichaoxianglouceng[3])
                decoration_1.append(huxingmianjichaoxianglouceng[4])
                tradingarea_1.append(district_metor[0])
                record_1.append(locdtime[1])
            ...
            for t in houseketword:
                ...
                house_1.append(houseketword_1)
                #print(houseketword_1)
    #print(a)            
    data = {
        'houseketword':house_1,
        'rent':rent_2,
        'housetype':housetype_1,
        'area':area_1,
        'district':district_1,
    ...
    print(df)
    df.to_csv('house_love.csv',index=False,encoding='utf_8_sig')
